...
public class EngineEnemy extends Character implements ISavable{
    ...
    public EngineEnemy(Character player, JSONObject properties) {
        super(properties);
        this.player = player;
...
public void initialize(JSONObject properties) {
 ...
 // **A LÓGICA DE CONTROLO ESTÁ AQUI**
    ...
    private void setupAnimations(Animator animator) {
        animator.addAnimation("idle", new com.jdstudio.engine.Graphics.Sprite.Animations.Animation(10, EnginePlayingState.assets.getSprite("enemy")));
        animator.play("idle");
    }
